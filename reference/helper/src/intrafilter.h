...
extern "C"
{
  ...
  LIGHTVIDEO_EXPORT void lvDefilterSubTop8(uint8_t *data, int width, int height, int bpp);

  LIGHTVIDEO_EXPORT void lvFilterSubLeft8(uint8_t *data, int width, int height, uint8_t threshold);
  LIGHTVIDEO_EXPORT void lvDefilterSubLeft8(uint8_t *data, int width, int height, int bpp);

  LIGHTVIDEO_EXPORT void lvFilterSubAvg8(uint8_t *data, int width, int height, uint8_t threshold);
  LIGHTVIDEO_EXPORT void lvDefilterSubAvg8(uint8_t *data, int width, int height, int bpp);

  LIGHTVIDEO_EXPORT void lvFilterSubPaeth8(uint8_t *data, int width, int height, uint8_t threshold);
  LIGHTVIDEO_EXPORT void lvDefilterSubPaeth8(uint8_t *data, int width, int height, int bpp);

  // 16bit
  LIGHTVIDEO_EXPORT void lvFilterSubTop16(uint16_t *data, int width, int height, uint16_t threshold);
  LIGHTVIDEO_EXPORT void lvDefilterSubTop16(uint16_t *data, int width, int height, int bpp);

  LIGHTVIDEO_EXPORT void lvFilterSubLeft16(uint16_t *data, int width, int height, uint16_t threshold);
  LIGHTVIDEO_EXPORT void lvDefilterSubLeft16(uint16_t *data, int width, int height, int bpp);

  LIGHTVIDEO_EXPORT void lvFilterSubAvg16(uint16_t *data, int width, int height, uint16_t threshold);
  LIGHTVIDEO_EXPORT void lvDefilterSubAvg16(uint16_t *data, int width, int height, int bpp);

  LIGHTVIDEO_EXPORT void lvFilterSubPaeth16(uint16_t *data, int width, int height, uint16_t threshold);
  LIGHTVIDEO_EXPORT void lvDefilterSubPaeth16(uint16_t *data, int width, int height, int bpp);
#ifdef __cplusplus
} // extern "C"
#endif // __cplusplus