...
{ return defilterSubTop(data, width, height); }
...
{ return defilterSubLeft(data, width, height); }
...
{ return defilterSubAvg(data, width, height); }
...
{ return defilterSubPaeth(data, width, height); }
